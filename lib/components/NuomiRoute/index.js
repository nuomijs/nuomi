...
function (_React$PureComponent) {
  ...
  _createClass(NuomiRoute, [{
    ...
    value: function loadProps(cb) {
      ...
      if (!loaded) {
        async(function (props) {
          _this3.setState({
            loaded: true,
            props: (0, _utils.extend)(rest, props)
          }, cb);
        });
      } else {
        cb && cb();
    ...
    value: function removeWrapper() {
      ...
      if (current) {
        NuomiRoute.wrappers = NuomiRoute.wrappers.filter(function (wrapper) {
    ...
    value: function visibleWrapperHandler() {
      var current = this.wrapperRef.current;
      NuomiRoute.wrappers.forEach(function (wrapper) {
        var elem = wrapper;
    ...
    value: function render() {
      ...
      var propsData = _objectSpread({}, props.data);

      var routeComponent = _react.default.createElement(_RouterContext.default.Consumer, null, function (_ref) {
        ...
        return _react.default.createElement(_BaseRoute.default, _extends({
          ref: _this4.ref
        }, props, extraProps, {
          data: propsData,
          location: rest
...
_defineProperty(NuomiRoute, "wrappers", []);
