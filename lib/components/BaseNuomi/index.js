...
function (_React$PureComponent) {
  ...
  _createClass(BaseNuomi, [{
    ...
    value: function getEffects() {
      ...
      if ((0, _utils.isFunction)(effects)) {
    ...
    value: function createStore() {
      ...
      function () {
        ...
        regeneratorRuntime.mark(function _callee(_ref) {
          var type, payload, splitIndex, queue, effectsProxy, loadingPayload, lastEffect, res, id, effect, $store, _res;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  queue = [];
                  _context.prev = 6;
                  effectsProxy = (0, _effectsProxy.default)(_this3.effects, {
                    get: function get(target, name) {
                      var effect = _this3.effects[name];
