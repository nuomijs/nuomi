  ...
  _createClass(StaticRouter, [{
    ...
    value: function getStaticLocation() {
      ...
      return {
        search: search,
        hash: hash,
        pathname: (0, _parser.normalizePath)(pathname),
        replace: _utils.noop
      };
    }
  }, {
    ...
    value: function render() {
      ...
      var staticLocation = this.getStaticLocation();
...
_defineProperty(StaticRouter, "propTypes", _propTypes.StaticRouterPropTypes);
