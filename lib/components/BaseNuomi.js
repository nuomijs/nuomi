...
function (_React$PureComponent) {
  ...
  _createClass(BaseNuomi, [{
    ...
    value: function createStore() {
      ...
      function () {
        ...
        regeneratorRuntime.mark(function _callee(action) {
          var type, payload, splitIndex, loadingQueue, loadingType, effectsProxy, loadingPayload, lastEffect, id, effect, $store, dispatchReturn;
    ...
    value: function render() {
      var props = this.props;
      var childrenContent = props.children;
      var renderContent = props.render ? props.render() : null;
      return childrenContent || renderContent ? _react.default.createElement(_Context.NuomiContext.Provider, {
        value: this.contextValue
      }, renderContent, childrenContent) : null;
    }
  }]);
