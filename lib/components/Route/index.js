...
function (_React$PureComponent) {
  ...
  _createClass(Route, [{
    ...
    value: function render() {
      ...
      var props = (0, _utils.extend)((0, _nuomi.getDefaultProps)(), this.props);
      var path = props.path,
          wrapper = props.wrapper; // 重复的path将不被渲染
      ...
      return _react.default.createElement(_RouterContext.default.Consumer, null, function (_ref) {
        ...
        if (!location.reload && wrapper && _this2.routeComponent && !match) {
          return _this2.routeComponent;
        }

        if (match) {
          _this2.routeComponent = _react.default.createElement(_NuomiRoute.default, _extends({}, props, {
            location: location,
            store: _this2.store,
            ref: _this2.ref
          }));
