...
function (_React$PureComponent) {
  ...
  function Nuomi() {
    ...
    _this.state = {
      loaded: !isAsync,
      props: isAsync ? rest : (0, _extend.default)((0, _nuomi.getDefaultProps)(), rest)
    };
    return _this;
  }
  ...
  _createClass(Nuomi, [{
    ...
    value: function loadProps() {
      ...
      if (!loaded) {
        async(function (props) {
          _this2.setState({
            loaded: true,
            props: (0, _extend.default)((0, _nuomi.getDefaultProps)(), (0, _extend.default)(rest, props))
          });
        });
      }
    }
    ...
    value: function render() {
      ...
      if (loaded) {
        return _react.default.createElement(_BaseNuomi.default, _extends({}, props, {
          store: this.store
        }));
      }
