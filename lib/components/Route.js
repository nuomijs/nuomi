  ...
  _createClass(Route, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_Context.RouterContext.Consumer, null, function (context) {
        ...
        var match = _router.default.matchPath(location, path); // context.matched 表示同一个上下文中，多个路由只匹配一个
          ...
          if (baseRouteComponent) {
            ...
            if (props.onLeave) {
              var leave = function leave() {
                ...
                _router.default.location(location, location.data, location.reload);
              };
              ...
              if (activeRouteComponent === null) {
                (0, _invariant.default)(false, 'onLeave中进行跳转只能发生在异步操作或者确认框回调中');
              } // 防止onLeave重复执行
              ...
              if (leaveResult === false) {
                ...
                (0, _router.restoreLocation)(props.location);
                return _this2.routeComponent;
              }
            }
          }
