...
var Route = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(Route, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_Context.RouterContext.Consumer, null, function (context) {
        ...
        _this2.context = context; // 同一个context只匹配一次

        var allowMatch = !context.matched || context.matched === _this2;

        var matchLocation = allowMatch && _router.default.matchPath(context.location, path);
