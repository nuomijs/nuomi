...
var RouteCore = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(RouteCore, [{
    ...
    key: "setTempData",
    value: function setTempData(locationData) {
      var nuomiProps = this.state.nuomiProps;
    ...
    value: function getNextProps() {
      ...
      var nuomiProps = this.state.nuomiProps;
      ['path', 'cache', 'reload', 'children'].forEach(function (value) {
        // 优先使用props
    ...
    value: function render() {
      ...
      if ((0, _utils.isObject)(location.data)) {
        this.setTempData(location.data);
      }

      if (cache === true || loaded && visible) {
        var baseRoute = _react.default.createElement(_BaseRoute.default, _extends({}, nuomiProps, props));
