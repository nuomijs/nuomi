...
function (_BaseNuomi) {
  ...
  _createClass(BaseRoute, [{
    ...
    value: function routerChange() {
      ...
      if ((0, _utils.isFunction)(props.onChange)) {
        props.onChange();
      } else if ((0, _utils.isObject)(props.onChange)) {
        Object.values(props.onChange).forEach(function (change) {
          if ((0, _utils.isFunction)(change)) {
            change.call(props);
          }
        });
      }
