...
var withNuomi = function withNuomi(WrapperComponent) {
  ...
  function (_React$PureComponent) {
    ...
    function WithNuomi() {
      ...
      _this.location = nuomiProps ? nuomiProps.location : (0, _router.getLocation)();
      return _this;
    }
  ...
  }), _defineProperty(_class, "displayName", "withNuomi(".concat(WrapperComponent.displayName || WrapperComponent.name, ")")), _temp;
};
