...
var withNuomi = function withNuomi(WrapperComponent) {
  ...
  function (_React$PureComponent) {
    ...
    function WithNuomi() {
      ...
      var sourceProps = _this.context.sourceProps;
      _this.location = sourceProps ? sourceProps.location : (0, _router.getLocation)();
      return _this;
    }
    ...
    _createClass(WithNuomi, [{
      ...
      value: function render() {
        var sourceProps = this.context.sourceProps;
