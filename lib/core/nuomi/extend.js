...
var _default = function _default() {
  ...
  if ((0, _utils.isObject)(newObject)) {
    ...
    if ((0, _utils.isObject)(reducers)) {
      currentObject.reducers = _objectSpread({}, object.reducers);
      Object.keys(reducers).forEach(function (key) {
        if ((0, _utils.isFunction)(reducers[key])) {
    ...
    if (keys.includes('onChange')) {
      if ((0, _utils.isObject)(onChange)) {
        currentObject.onChange = _objectSpread({}, currentObject.onChange, {}, onChange);
      } else if ((0, _utils.isFunction)(onChange)) {
        currentObject.onChange = _objectSpread({}, currentObject.onChange, {
          _onChange: onChange
        });
      } else {
