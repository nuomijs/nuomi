...
var composeEnhancers = process.env.NODE_ENV !== 'production' && _globalWindow.default.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ ? _globalWindow.default.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__({
  trace: true,
  traceLimit: 20
}) : _redux.compose;
var globalStore = (0, _redux.createStore)(_utils.noop, // eslint-disable-next-line no-return-assign
...
var clearStore = function clearStore() {
  stores = {};
  globalStore.replaceReducer(_utils.noop);
};

exports.clearStore = clearStore;
globalStore.getStore = getStore;

globalStore.applyMiddleware = function () {
  if (!usedDispatch) {
...
globalStore.createState = function () {
