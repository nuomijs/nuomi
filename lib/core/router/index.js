...
function combinePath() {
  ...
  return (0, _parser.normalizePath)("".concat(options.basename, "/").concat((0, _parser.restorePath)(path)));
}
...
function back(step) {
  _globalWindow.default.history.back(step);
}

function forward(step) {
  _globalWindow.default.history.forward(step);
}
...
function matchPath() {
  ...
  return match.apply(void 0, args.concat([true]));
}
