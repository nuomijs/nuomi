...
exports.default = exports.getClassEffects = void 0;

var _proxyPolyfill = _interopRequireDefault(require("./proxyPolyfill"));

var _index = require("./index");

var _globalWindow = _interopRequireDefault(require("./globalWindow"));
...
var ProxyObject = _globalWindow.default.Proxy; // 是否原生支持Proxy

var supportProxy = (0, _index.isNative)(ProxyObject);
var EffectsProxy = supportProxy ? ProxyObject : (0, _proxyPolyfill.default)(); // 获取以类方式创建的effects实例对象

var getClassEffects = function getClassEffects(effects) {
...
exports.getClassEffects = getClassEffects;
var _default = EffectsProxy;
